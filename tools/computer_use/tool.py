...
def handle_computer_use(args: Dict[str, Any], **kwargs) -> Any:
    ...
    if not foreground_request and action in _DESTRUCTIVE_ACTIONS:
...
def _dispatch(backend: ComputerUseBackend, action: str, args: Dict[str, Any]) -> Any:
    ...
    if action == "capture":
        ...
        return _capture_response(cap, persist=persist_image)
...
# Preserve the complete local AX-tree guard even though the model-facing
# element list now has an upstream-fixed cap.
