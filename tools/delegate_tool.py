...
def _run_single_child(
    ...
    **_kwargs,
    ...
    try:
        ...
        # error in final_response. Structured failure data remains authoritative:
        # error text is diagnostic output, not a successfully completed task.
        # Legacy/partial results may omit ``failed`` while retaining ``error``.
        _child_failed = bool(result.get("failed") or result.get("error"))
